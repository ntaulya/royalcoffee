                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;"
                                                                    ...
                                                                    <table class="card-body" role="presentation"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                                                                    align="left">
                                                                                    <img class="img-fluid"
                                                                                        style="width: 120px; height: 35.58px; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; border-style: none; border-width: 0;"
                                                                                        src="{{$image_logo_pt}}"
                                                                                        alt="Logo Rapidtes"
                                                                                        width="100%">
                                                                                    <table class="ax-center"
                                                                                        role="presentation"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <img class="img-fluid"
                                                                                                        style="margin-top: 20px; height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; width: 100%; border-style: none; border-width: 0;"
                                                                                                        src="{{$image_benner}}"
                                                                                                        alt="Some Image"
                                                                                                        width="100%">
                                                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <p class=""
                                                                                                        style="font-size: 20px; line-height: 24px; width: 100%; margin: 20px 0 0;"
                                                                                                        align="left">
                                                                                                        KODE VERIFIKASI
                                                                                                    </p>
                                                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <p class=""
                                                                                                        style="font-size: 16px; line-height: 24px; width: 100%; margin: 15px 0 0;"
                                                                                                        align="left">
                                                                                                        Berikut adalah
                                                                                                        kode verifikasi
                                                                                                        yang dapat
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <p class=""
                                                                                                        style="font-size: 30px; line-height: 24px; width: 100%; margin: 20px 0 0;"
                                                                                                        align="left">
                                                                                                        {{ $code_otp }}
                                                                                                    </p>
                                                                                                </td>
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                                                    align="left">
                                                                                                    <p class=""
                                                                                                        style="font-size: 12px; line-height: 24px; width: 100%; margin: 10px 0 0;"
                                                                                                        align="left">
                                                                                                        Kode di atas
                                                                                                        hanya berlaku
                                                                                                        dalam 5 menit.

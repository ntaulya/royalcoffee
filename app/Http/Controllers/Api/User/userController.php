...
class userController extends Controller
{
    ...
    public function updateUser(V_Update $request){
        $value = $request->validated(); 
        $value = [
            'user_id'      => (is_null($value['user_id'])) ? null : $value['user_id'],
            'nama_lengkap' => (is_null($value['nama_lengkap'])) ? null : $value['nama_lengkap'],
            'email'        => (is_null($value['email'])) ? null : $value['email'],
            'phone'        => (is_null($value['phone'])) ? null : $value['phone'],
            'password'     => (is_null($value['password'])) ? null : $value['password'],
        ];

...
class HomeNonCoffee extends StatefulWidget {
  ...
  @override
  State<HomeNonCoffee> createState() => _HomeNonCoffeeState();
}

class _HomeNonCoffeeState extends State<HomeNonCoffee> {
  final AuthController _controller = AuthController();
  String selectedCategory = "Non-Coffee";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset: false, // hindari overflow dari keyboard
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: GridView.count(
                          ...
                          children: [
                            _buildProductCard("Strawberry Tea", "Rp.26.000",
                                "assets/images/strawberry-tea.png"),
                            _buildProductCard("Chocolate", "Rp. 26.000",
                                "assets/images/chocolate.png"),
                            _buildProductCard("Red Velvet", "Rp. 26.000",
                                "assets/images/red-velvet.png"),
                            _buildProductCard("Lemon Tea", "Rp. 26.000",

...
class AdminCategoryTabs extends StatefulWidget {
  ...
  @override
  State<AdminCategoryTabs> createState() => _AdminCategoryTabsState();
}

class _AdminCategoryTabsState extends State<AdminCategoryTabs> {
